...
const DevPortfolio = () => {
  ...
  const bootSequence = [
    { text: '> SHIVA LASER SYSTEM BOOT INITIATED', delay: 0 },
    ...
    { text: '> Successful digitization of user to the Grid...', delay: 4000 },
    { text: '', delay: 4300 },
  ...
  return (
    <>
      ...
      <div className={`min-h-screen bg-black text-zinc-100 overflow-x-hidden transition-opacity duration-500 font-mono ${isBooting ? 'opacity-0' : 'opacity-100'}`}>
        ...
        {/* Footer */}
        <footer className="relative z-10 py-12 px-4 border-t border-zinc-800/50 bg-black/80" style={{ backdropFilter: 'blur(10px)' }}>
          <div className="max-w-6xl mx-auto">
            {/* Main Footer Content */}
            <div className="flex flex-col items-center gap-6 mb-8">
              <p className="text-center text-lg font-semibold font-mono" style={{ color: '#00ff41', textShadow: '0 0 20px rgba(0,255,65,0.5)' }}>
                Developed and Designed by Jordan Runyon 👾 Powered with React, Vite, and Tailwind
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-sm font-mono" style={{ color: '#00ff41' }}>© 2025 Jordan Runyon. All rights reserved.</div>
